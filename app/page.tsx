...
export default function LandingPage() {
  return (
    <main className="home min-h-screen bg-white text-[#1b1b1b]">
      <section className="bg-[#e7faef]">
        <header className="mx-auto flex min-h-20 max-w-[1090px] items-center justify-between gap-4 px-4 py-4 sm:px-6">
          <Link href="/" className="flex min-w-0 items-center gap-2 text-[#22ab59]">
            ...
            <span className="truncate text-xl font-bold">TaskBee</span>
          </Link>
        ...
        <div className="mx-auto grid max-w-[1090px] gap-10 px-4 pb-16 pt-10 sm:px-6 sm:pb-24 sm:pt-16 lg:grid-cols-[minmax(0,460px)_minmax(0,1fr)] lg:items-center">
          <div>
            <h1 className="max-w-[440px] text-4xl font-semibold uppercase leading-[1.18] tracking-normal text-[#30394d] sm:text-5xl lg:text-[56px]">
          ...
          <div className="relative min-h-[340px] sm:min-h-[420px]">
            ...
            <div className="absolute right-0 top-6 w-full max-w-[445px] rounded-[7px] bg-[#eadfff] pt-8 shadow-sm sm:pt-12">
              <div className="mx-auto min-h-[300px] w-[90%] bg-white shadow-[0_20px_60px_rgba(32,50,89,0.10)] sm:min-h-[345px]">
                <div className="flex h-12 items-center justify-between gap-3 border-b border-[#f0f2f5] px-4 text-xs sm:px-8">
                ...
                <div className="space-y-5 p-4 sm:p-8">
                  ...
                  <div>
                    ...
                    <div className="h-4 w-full max-w-72 rounded bg-[#30394d]" />
          ...
          <p className="flex max-w-[520px] items-start gap-3 text-base italic leading-snug text-black sm:gap-4 sm:text-xl lg:col-start-2">
      ...
      <section className="mx-auto max-w-[1090px] px-4 py-16 sm:px-6 sm:py-24">
        <h2 className="text-3xl font-semibold leading-tight text-[#30394d] sm:text-[44px]">
      ...
      <section className="border-y border-[#f0f2f5] bg-[#f5f7fa]">
        <div className="mx-auto grid max-w-[1090px] gap-6 px-4 py-14 sm:px-6 sm:py-16 md:grid-cols-3">
          {stats.map((stat) => (
            <div key={stat.label}>
              <div className="text-4xl font-black text-[#22ab59] sm:text-[42px]">{stat.value}</div>
      ...
      <section className="mx-auto flex max-w-[1090px] flex-col gap-6 px-4 py-16 sm:px-6 sm:py-20 md:flex-row md:items-center md:justify-between">
        <div>
          <h2 className="text-3xl font-semibold text-[#30394d] sm:text-4xl">Sẵn sàng chạy thử TaskBee?</h2>
